...
\begin{itemize}
\item open several bibs in a \color{red}GUI\color{black}
...
\begin{frame}
\frametitle{Project baNaNa will meet again next year...}
...
\vspace{-0.5cm}
 \begin{figure}
\centering
 \includegraphics[height=0.4\textheight]{images/MC.jpg}
\end{figure}
\end{frame}
