...
\item auto-generate keys \texttt{[author] [year]}
\end{itemize}
\hfill
...
\begin{itemize}
 \item ctrl-K copies  ``$\backslash$cite$\{$currentKey$\}$`` to the clipboard
\end{itemize}
\vfill
\hfill
$\hookrightarrow$live performance
...
\begin{enumerate}
 \item Note that \texttt{JabRef} itself is a Java programm
 ...
 \item Follow the instructions (or ask Joost)
\end{enumerate}
\end{frame}
